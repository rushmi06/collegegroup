...
function AdminSignUp() {
  ...
  return (
    <div className='w-full h-[92vh] justify-center items-center flex flex-col gap-4'>
        <ToastContainer />
        {!otpSent && !uploading && <div className='white p-4 w-4/5 flex rounded-md shadow'>
            ...
            <div className='w-2/3 flex flex-col gap-4 '>
                ...
                <div className='flex items-center w-full gap-2'>
                    ...
                    <select onChange={changeHadler} name='designation' value={data.designation} className='w-1/2 px-2 py-1 rounded-md bg-transparent border border-black focus:outline outline-blue-600'>
                        <option value=''>--select--</option>
                        <option value='1st'>HODr</option>
                        <option value='2nd'>Staff</option>
                    </select>
                </div>
            </div>
        </div>}
        ...
        {verified &&<div className='flex flex-col items-center gap-4 '>
            ...
            <Link to='/adminlogin' className='blue px-4 py-1 hover:cursor-pointer text-white rounded-md'>Login</Link>
        </div>}
        {!otpSent && !verified && <div onClick={sendOtp} className='blue p-2 rounded-md w-1/12 text-center hover:cursor-pointer'>GET OTP</div>}
